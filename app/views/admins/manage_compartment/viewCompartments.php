	...
	<div class="body-section">
            ...
            <div class="content-row">
                <div class="container-table">
                    ...
                    <a class= "blue-btn" href="<?php echo URLROOT; ?>/Admin_manage_compartments/edit/<?php echo $data['trainId'];?>">Add New Compartment</a>
                    <table class="blue">
                        <thead>
                            <tr>
                                <th>Train ID</th>
                        ...
                        <tr>
                            ...
                            <td data-th="Manage">
                            <form action="<?php echo URLROOT . "/Admin_manage_compartments/delete/" . $compartment->trainId?>" method="POST">    
