    ...
    <div class="content-row">
	    <div class="container-table">
            ...
            <div class="table-searchbar">
                <form action="<?php echo URLROOT;?>/moderatorjourneys/journeysSearchBy" method="post">
                ...
                <script>
                    ...
                    <?php foreach ($data['journeys'] as $row):?>
	              	<tr>
	                    ...
	                    <td data-th="Manage">
							<form action="<?php echo URLROOT;?>/moderatorJourneys/deleteJourney/all" method="POST">
                                ...
                                <input type="hidden" name="journeyIdDel" id="journeyIdDel" value="<?php echo $row->journeyId;?>">
                                <input type="hidden" name="journeyIdDel" id="journeyIdDel" value="<?php echo $row->journeyId;?>">
							</form>
                        </td>
	                </tr>
            ...
            <div class="pagination">
                <ul>
                    <?php if(!isset($data['searchBar'])):?>
                        <li>
                            <?php if($data['start']==0):?>
                                <a href="<?php echo URLROOT;?>/moderatorJourneys/index?page=1" class="prev">Prev</a>
                            <?php else:?>
                                <a href="<?php echo URLROOT;?>/moderatorJourneys/index?page=<?php echo $data['page']-1;?>" class="prev">Prev</a>
                            <?php endif;?>
                        </li>

                        <?php for($page=1; $page<=$data['totalPages'];$page++){
                            if ($data['page']==$page){
                                echo '<li class="pageNumber active"><a href="'.URLROOT.'/moderatorJourneys/index?page='.$page.'">'.$page.'</a></li>';
                            }else{
                                echo '<li class="pageNumber"><a href="'.URLROOT.'/moderatorJourneys/index?page='.$page.'">'.$page.'</a></li>';
                            }
                        }
                        ?>
                        <li>
                            ...
                            <?php else:?>
                                <a href="<?php echo URLROOT;?>/moderatorJourneys/index?page=<?php echo $data['page']+1;?>" class="next">Next</a>
                            <?php endif;?>
                        </li>
                    <?php else:?>
                        ...
                        <li>
                            <?php if($data['start']==0):?>
                                <a href="<?php echo URLROOT;?>/moderatorJourneys/journeysSearchBy?page=1&amp;searchbar=<?php echo $searchBar;?>&amp;searchselect=<?php echo $searchSelect;?>" class="prev">Prev</a>
                            <?php else:?>
                                <a href="<?php echo URLROOT;?>/moderatorJourneys/journeysSearchBy?page=<?php echo $data['page']-1;?>&amp;searchbar=<?php echo $searchBar;?>&amp;searchselect=<?php echo $searchSelect;?>" class="prev">Prev</a>
                            <?php endif;?>
                        </li>

                        <?php for($page=1; $page<=$data['totalPages'];$page++){
                            if ($data['page']==$page){
                                echo '<li class="pageNumber active"><a href="'.URLROOT.'/moderatorJourneys/journeysSearchBy?page='.$page.'&amp;searchbar=' . $searchBar . '&amp;searchselect=' . $searchSelect . '">' . $page . '</a></li>';
                            }else{
                                echo '<li class="pageNumber"><a href="'.URLROOT.'/moderatorJourneys/journeysSearchBy?page='.$page.'&amp;searchbar=' . $searchBar . '&amp;searchselect=' . $searchSelect . '">' . $page . '</a></li>';
                            }
                        }
                        ?>
                        <li>
                            <?php if($data['page']==$data['totalPages']):?>
                                <a href="#" class="next">Next</a>
                            <?php else:?>
                                <a href="<?php echo URLROOT;?>/moderatorJourneys/journeysSearchBy?page=<?php echo $data['page']+1;?>&amp;searchbar=<?php echo $searchBar;?>&amp;searchselect=<?php echo $searchSelect;?>" class="next">Next</a>
                            <?php endif;?>
                        </li>
                    <?php endif;?>
                    </ul>
