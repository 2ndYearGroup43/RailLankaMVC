...
<html>
<head>
	<title>View Compartment Details</title>
...
<div class="body-section">
            <div class="content-flexrow">
                <div class="container-table">
                    <h2 style="color: #13406d;">Compartment Details </h2>
                    <table class="data-display" action="<?php echo URLROOT; ?>/manage_compartment/views/<?php echo $data['manage_compartment']->officerId?>" method = "POST">
                        <tr>
                            <td >Train ID: </td>
