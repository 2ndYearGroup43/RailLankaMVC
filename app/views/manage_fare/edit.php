...
<html>
<head>
	<title>Update Fare Details</title>
...
?> 
    <div class="body-section">
        <div class="content-flexrow">
           <div class="container">
            <div class="text">Manage Trains<small>Update Fare Details</small></div>
            <form action="<?php echo URLROOT; ?>/manage_fare/edit/<?php echo $data['manage_fare']->rateID?>" method ="POST">
                <div class="form-row">
