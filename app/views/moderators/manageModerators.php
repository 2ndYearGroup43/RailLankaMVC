    ...
    <div class="body-section">
        ...
        <div class="content-row">
            <div class="container-table">
                <h1>Moderators <small>User Management</small></h1>
                <div class="table-searchbar">
                    <form action="<?php echo URLROOT?>/moderators/moderatorsSearchBy" method="POST">
                ...
                <div class="container-table popup" id="popup-alert">
                    ...
                    <table class="data-display" id="cancelpopup">
                        ...
                        <button style="position: relative; padding: 10px 15px;" class="back-btn"><i class="fa fa-times" onclick="closeModeratorView()"></i></button>
                    </table>
                </div>
                <table class="blue">
                    <thead>
                    ...
                    <?php $count=0?>
                    <!-- <?php var_dump($data);?> -->
                    <?php foreach ($data['moderators'] as $row):?>
                        <tr>
                            <td data-th="User ID"><?php echo $row->userid;?></td>
                            <td data-th="Modertor ID"><?php echo $row->moderatorId;?></td>
                            ...
                            <td data-th="Manage">
                                <form action="<?php echo URLROOT;?>/moderators/deleteUser/<?php echo $row->userid;?>" method="POST">
                                <button type="button" class="table-btn blue" onclick="openModeratorView(alerts,<?php echo $count;?>)">View</button>
                                <a href="<?php echo URLROOT;?>/moderators/updateModerator/<?php echo $row->userid;?>" class="blue-btn">Edit</a>
                ...
                <script>
                    function openModeratorView(alerts,x) {
