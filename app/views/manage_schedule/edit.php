...
<html>
<head>
	<title>Update Schedule Details</title>
...
<div class="body-section">
        <div class="content-flexrow">
               <div class="container">
                <div class="text">Update Schedule</div>
                <form action="<?php echo URLROOT; ?>/manage_schedule/edit/<?php echo $data['manage_schedule']->routeId?>" method = "POST">
                                <div class="form-row">
                                    <div class="input-data">
                                        <label for="routeId">Route Id</label>
                                        <input type="text" name="routeId" value="<?php echo $data['manage_schedule']->routeId?>" id="routeId" required >
                                    </div>
                                    <div class="input-data">
                                        <label for="stationId">Station Id</label>
                                        <input type="text" name="stationId" value="<?php echo $data['manage_schedule']->stationId?>" id="stationId" required >
