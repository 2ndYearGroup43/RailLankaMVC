    ...
    <div class="body-section">
        ...
        <div class="content-row">
            <div class="container-table">
                <h1>Drivers <small>User Management</small></h1>
                <div class="table-searchbar">
                    <form action="<?php echo URLROOT?>/drivers/driversSearchBy" method="POST">
                ...
                <div class="container-table popup" id="popup-alert">
                    ...
                    <table class="data-display" id="cancelpopup">
                        ...
                        <button style="position: relative; padding: 10px 15px;" class="back-btn"><i class="fa fa-times" onclick="closeDriverView()"></i></button>
                    </table>
                </div>
                <table class="blue">
                    <thead>
                    ...
                    <?php $count=0?>
                    <!-- <?php var_dump($data);?> -->
                    <?php foreach ($data['drivers'] as $row):?>
                        <tr>
                            ...
                            <td data-th="Manage">
                                <form action="<?php echo URLROOT;?>/drivers/deleteUser/<?php echo $row->userid;?>" method="POST">
                                <button type="button" class="table-btn blue" onclick="openDriverView(alerts,<?php echo $count;?>)">View</button>
                                <a href="<?php echo URLROOT;?>/drivers/updateDriver/<?php echo $row->userid;?>" class="blue-btn">Edit</a>
                ...
                <script>
                    function openDriverView(alerts,x) {
                        ...
                        table.rows.namedItem("driverId").cells.namedItem("driverId").innerHTML=alerts[x].driverId;
