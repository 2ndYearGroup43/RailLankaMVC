...
<div class="body-section">
    <div class="content-flexrow">
        <div class="container">
            <div class="text">Employee Registration <small>Moderator</small></div>
            <form action="<?php echo URLROOT;?>/moderators/registermoderator" method="POST">
                <div class="form-row">
                    <div class="input-data">
                        <label for="moderatorId">Moderator Id</label>
                        <input type="text" name="moderatorId" id="moderatorId" required >
                        <span class="invalidFeedback">
                            <?php echo $data['moderatorIdError'];?>
                        </span>
                    </div>
                    <div class="input-data">
