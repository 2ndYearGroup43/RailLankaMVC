			...
			<div class="row">
				...
				<div class="compartment-container">
				   	...
				   	<div class='compartment-area'>
					   	...
					   	<input onclick="location.href='<?php echo URLROOT; ?>/resofficerReservations/displaySeatMaps5'" type="submit" class="compartment active-comp" value="Wagon 5">
