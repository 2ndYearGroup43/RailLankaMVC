...
<!-- delayed train results -->
	<div class="body-section">
		...
		<div class="table-container">
			...
			<h1 class="title delayed-title">Delayed Trains</h1>
				<table class="content-table">
					...
					<tbody>
						...
						<tr class="active-row">
							...
							<td class="alert-important" data-label="Journey Date"><?php echo $row->delaydate ?></td>
							<td class="alert-important" data-label="Delay Time"><?php echo $row->delaytime ?></td>
