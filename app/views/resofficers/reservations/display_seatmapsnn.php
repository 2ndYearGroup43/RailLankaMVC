...
<header>
	...
	<div class="body-section">
		...
		<div class="map-container2">
			...
			<center><p>	Train ID : 101COLBAD0630</p></center>
			...
			<br><br><br><br><br>		
			<button id="options-once" onclick="location.href='<?php echo URLROOT; ?>/resofficerReservations/getPaasengerDetails'" class="btn checkout-btn">BOOK NOW &raquo;</button>
