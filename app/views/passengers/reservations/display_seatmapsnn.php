...
<?php var_dump($_SESSION); ?> 
	...
	<div class="body-section">
		...
		<div class="map-container2">
			...
			<!-- end of js for seat maps -->
				...
				<div class="tabs__content" data-tab="2">
			    	...
			    	<div class="right-map">
						<div class="booking-detailsn">
							<h2>Booking Details</h2>
							<h3> Selected Seats (<span id="counter2">0</span>):</h3>
					...
					<script>		
						...
						//let's pretend some seats have already been booked
						// sc.get(['1_2', '7_1', '7_2']).status('unavailable');
						sc.get(['2_1', '2_2', '4_5', '4_6']).status('unavailable');
						// sc3.get(['3_2']).status('unavailable');
						// sc4.get(['2_1', '2_2', '2_3', '5_5']).status('unavailable');
						// sc5.get(['5_1', '5_3']).status('unavailable');
						// sc6.get(['2_5']).status('unavailable');
			...
			<!-- end of js for seat maps -->
				...
				<div class="tabs__content" data-tab="3">
			    	...
			    	<div class="right-map">
						<div class="booking-detailsn">
							<h2>Booking Details</h2>
							<h3> Selected Seats (<span id="counter3">0</span>):</h3>
			...
			<!-- end of js for seat maps -->
				...
				<div class="tabs__content" data-tab="4">
			    	...
			    	<div class="right-map">
						<div class="booking-detailsn">
							<h2>Booking Details</h2>
							<h3> Selected Seats (<span id="counter4">0</span>):</h3>
					...
					<script>		
						...
						// sc2.get(['2_1', '2_2', '4_5', '4_6']).status('unavailable');
						// sc3.get(['3_2']).status('unavailable');
						sc.get(['2_1', '2_2', '2_3', '5_5']).status('unavailable');
						// sc5.get(['5_1', '5_3']).status('unavailable');
						// sc6.get(['2_5']).status('unavailable');
			...
			<!-- end of js for seat maps -->
				...
				<div class="tabs__content" data-tab="5">
			    	...
			    	<div class="right-map">
						<div class="booking-detailsn">
							<h2>Booking Details</h2>
							<h3> Selected Seats (<span id="counter5">0</span>):</h3>
					...
					<script>		
						...
						// sc3.get(['3_2']).status('unavailable');
						// sc4.get(['2_1', '2_2', '2_3', '5_5']).status('unavailable');
						sc.get(['5_1', '5_3']).status('unavailable');
						// sc6.get(['2_5']).status('unavailable');
			...
			<!-- end of js for seat maps -->
				...
				<div class="tabs__content" data-tab="6">
			    	...
			    	<div class="right-map">
						<div class="booking-detailsn">
							<h2>Booking Details</h2>
							<h3> Selected Seats (<span id="counter6">0</span>):</h3>
			...
			<p class="options">Back to seat map? <a href="<?php echo URLROOT; ?>/passengerReservations/displayTrains">Click here.</a></p>
		</div>		
		<div class="content-row">
		</div>
		<div class="content-row">
