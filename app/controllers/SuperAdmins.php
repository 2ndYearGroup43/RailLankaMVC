<?php
    class SuperAdmins extends Controller{
        ...
        public function index()
        {
            ...
            $fields=$this->superAdminModel->getAdminFields();
            $data=[
                'admins'=>$admins,
                'fields'=>$fields
            ];
        ...
        public function registerAdmin()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                if(empty($data['adminId'])){
                    ...
                    //if adminId exists
                    if($this->superAdminModel->findAdminByadminId($data['adminId'])){
                ...
                if(empty($data['employeeId'])){
                    ...
                    if($this->superAdminModel->findAdminByEmployeeId($data['employeeId'])){
                ...
                if(empty($data['email'])){
                    ...
                    //if email exists
                    if($this->superAdminModel->findAdminByEmail($data['email'])){
                ...
                // empty($data['passwordError']) && empty($data['confirmPasswordError'])){
                        ...
                        if($this->superAdminModel->registerAdmin($data)){
        ...
        {   
            ...
            if(!$this->superAdminModel->requestReset($email,$code)){
                die('Something went wrong');
            }
        ...
        public function updateAdmin($userid)
        {
            ...
            $admin=$this->superAdminModel->findAdminById($userid);
            $data=[
                'userid'=>$userid,
                'admin'=>$admin,
                'employeeId'=>'',
            ...
            if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                if(empty($data['employeeId'])){
                    ...
                    //if Employee ID exists
                    if($this->superAdminModel->findAdminByEmployeeId($data['employeeId']) &&
                    $this->superAdminModel->findAdminById($userid)->employeeId!=$data['employeeId']){
                        $data['employeeIdError']='This employee is already registered as a Admin in the system.'; 
                    }
                }
                if(empty($data['firstname'])){
                ...
                if(empty($data['email'])){
                    ...
                    //if email exists
                    if($this->superAdminModel->findAdminByEmail($data['email']) &&
                    $this->superAdminModel->findAdminById($userid)->email!=$data['email']){
                        $data['emailError']='Entered email is already registered in the system.'; 
                    }
                }
                ...
                if ($data['employeeId']==$this->superAdminModel->findAdminById($userid)->employeeId &&
                    $data['firstname']==$this->superAdminModel->findAdminById($userid)->firstname &&
                    $data['lastname']==$this->superAdminModel->findAdminById($userid)->lastname &&
                    $data['email']==$this->superAdminModel->findAdminById($userid)->email &&
                    $data['mobileno']==$this->superAdminModel->findAdminById($userid)->mobileno
                    ){
        ...
        public function adminsSearchBy()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                $admins=$this->superAdminModel->searchAdmins($data['searchBar'],$data['searchSelect']);
                $fields=$this->superAdminModel->getAdminFields();
                $data=[
                    'admins'=>$admins,
                    'fields'=>$fields,
        ...
        public function deleteUser($userid)
        {
            if($_SERVER['REQUEST_METHOD']=='POST'){
                $_POST=filter_input_array(INPUT_POST, FILTER_SANITIZE_STRING);
                if ($this->superAdminModel->deleteUser($userid)) {
                    header("Location: ".URLROOT."/admins/viewAdmins");
                } else {
                    die("Something went wrong");
                }
        ...
        public function login()
        {
            ...
            if($_SERVER['REQUEST_METHOD']=='POST'){
                ...
                if(empty($data['usernameError'])&& empty($data['passwordError'])){
                    $loggedInUser=$this->superAdminModel->login($data['username'] ,$data['password']);
