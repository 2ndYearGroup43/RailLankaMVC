                ...
                <div class="container-table">
                    ...
                    <table class="data-display" >
                        ...
                        <tr>
                            ...
                            <td> <a href="<?php echo URLROOT; ?>/Admin_manage_schedules/viewSchedule/<?php echo $data['trainId']?>" class="blue-btn">View&Manage</a></td>
                            <td colspan="2"></td>
                        </tr>
                        <tr>
                            <td>View & Manage Days</td>
                            <td> <a href="<?php echo URLROOT; ?>/Admin_manage_available_days/edit/<?php echo $data['trainId']?>" class="blue-btn">View&Manage</a></td>
                            <td colspan="2"></td>
                        </tr>
                        <tr>
                            <td>View & Manage Compartments</td>
                            <td> <a href="<?php echo URLROOT; ?>/Admin_manage_compartments/viewCompartments/<?php echo $data['trainId']?>" class="blue-btn">View&Manage</a></td>
                            <td colspan="2"></td>
                        </tr>
                    </table>
