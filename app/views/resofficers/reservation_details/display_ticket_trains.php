            ...
            <div class="content-row">
                ...
                <div class="pagination">
                    <ul>
                        ...
                        <li class="pageNumber active"><a href="<?php echo URLROOT; ?>/ResOfficerReservationDetails/displayTicketTrains">1</a></li>
                        <li class="pageNumber"><a href="<?php echo URLROOT; ?>/ResOfficerReservationDetails/displayTicketTrains">2</a></li>
                        <li class="pageNumber"><a href="<?php echo URLROOT; ?>/ResOfficerReservationDetails/displayTicketTrains">3</a></li>
                        <li><a href="<?php echo URLROOT; ?>/ResOfficerReservationDetails/displayTicketTrains" class="next">Next</a></li>
                    </ul>
                </div>
                <br>
