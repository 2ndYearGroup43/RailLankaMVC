	...
	<div class="body-section">
		...
		<div class="table-container">
			...
			<h1 class="title">Search Results</h1>
				...
				<center><button onclick="location.href='<?php echo URLROOT; ?>/passengerSchedules/search'" class="btn blue-btn back-btn"><i class="fa fa-long-arrow-left"></i > Back</button></center>	
		</div>
		<div class="content-row">
		</div>
		<div class="content-row">
