        ...
        <div class="body-section">
            ...
            <div class="content-row">
                <div class="container-table">
                    ...
                    <a class= "blue-btn" href="<?php echo URLROOT; ?>/Admin_manage_fares/create">Add New Rate</a>
                    <table class="blue">
                        <thead>
                            <tr>
                                <th>Rate ID</th>
                        ...
                        <tr>
                            ...
                            <td data-th="Manage">
                            <form action="<?php echo URLROOT . "/Admin_manage_fares/delete/" . $post->rateID?>" method="POST">    
                            <a class= "blue-btn" href="<?php echo URLROOT . "/Admin_manage_fares/views/" . $post->rateID?>">View</a>
                            <a class= "blue-btn" href="<?php echo URLROOT . "/Admin_manage_fares/edit/" . $post->rateID?>">Edit</a>
