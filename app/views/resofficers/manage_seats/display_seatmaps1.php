			...
			<div class="row">
				...
				<div class="compartment-container">
				   	...
				   	<div class='compartment-area'>
				   		<input onclick="location.href='<?php echo URLROOT; ?>/resofficerManageSeats/displaySeatMaps'" type="submit" class="compartment active-comp" value="Wagon 1">
	...
	<div class="flash-alert-box" id="alert-warning-popup">
		<div class="alert-box-content">
			...
			<div class="alert-body">
				...
				<button onclick="location.href='<?php echo URLROOT; ?>/resofficerManageSeats/displayTrains'" class="proceed-btn">Proceed Anyway</button>
			</div>
