...
<!-- search results -->
	<div class="body-section">
		...
		<div class="table-container">
				...
				<table class="content-table">
					...
					<tbody>
						<tr class="active-row">
							...
							<td>
								<button onclick="location.href='<?php echo URLROOT; ?>/schedules/displayTrainDetails'" type="submit" class="btn"><span>Details</span></button>
							</td>
						</tr>
						<tr>
							<td data-label="From">Colombo Fort</td>
							...
							<td>
								<button onclick="location.href='<?php echo URLROOT; ?>/schedules/displayTrainDetails'" type="submit" class="btn">Details</button>
							</td>
						</tr>
						<tr>
							<td data-label="From">Colombo Fort</td>
			...
			<!-- </div> -->
				<button onclick="location.href='<?php echo URLROOT; ?>/schedules/search'" type="submit" class="btn blue-btn back-btn">Back</button>
		</div>
		<div class="content-row">
		</div>
		<div class="content-row">
		...
		<div class="modal-content">
			...
			<div class="notices-container">
				<div class="mini-schedule">
					...
					<button onclick="location.href='<?php echo URLROOT; ?>/schedules/displayTrains'" class="btn blue-btn">Go <i class="fa fa-long-arrow-right"></i></button>
				</div>
			</div>
		</div>
	</div>
